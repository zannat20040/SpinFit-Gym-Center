        ...
        <div className="card-body">
            <div className="flex justify-between">
                ...
                <div className="font-medium uppercase text-black flex gap-3 items-center">
                    ...
                    <span>{forum?.postDetail?.date}</span>
                </div>
            </div>
            ...
            {forum?.postDetail?.post.split(" ").length > 20 ? (
                <p className="text-white font-roboto">
                  ...
                  <Link to = {`http://localhost:5173/community/${forum?._id}`} className="uppercase  text-[#dde244] font-medium rounded-none flex gap-3 items-center py-3">
